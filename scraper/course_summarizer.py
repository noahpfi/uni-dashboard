...
Output valid JSON only:
{
  ...
  "deadlines": [
    {"date": "YYYY-MM-DD", "description": "<one clear sentence: what must be done, for which course/exam/assignment, and any relevant detail (e.g. location, submission method, group size). Not just a label — a student should know what to do from this alone. - vorlesungen, unless explicitly stated mandatory attendence, are not deadlines.>"}
  ],
